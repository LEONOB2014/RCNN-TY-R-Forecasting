        ...
        for i in self.idx_list.index:
            if idx > self.idx_list.loc[i,"idx_e"]:
                ...
                for j in range(self.input_frames):
                    ...
                    rad_data.append(np.load(os.path.join(self.root_dir,'RAD',year+'.'+i+"_"+rad_file_time+".npy")))
                ...
                for j in range(self.input_frames,self.input_frames+self.output_frames):
                    ...
                    qpe_data.append(np.load(os.path.join(self.root_dir,'QPE',year+'.'+i+"_"+qpe_file_time+".npy"))[60:120,60:120])
